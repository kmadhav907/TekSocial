            ...
            <div class="card-header border-0" style="background-color: #393939">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <button class="btn btn-info float-right">Settings</button>
                  <button
                    class="btn btn-info float-right"
                    @click="submitDataToBacked()"
                  >
                    Edit profile
                  </button>
                </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group focused">
                    ...
                    <textarea
                      ...
                      v-model="userAbout"
                    >
Passionate about Life</textarea
                    >
                  </div>
                </div>
              </form>
...
import { UPDATE_USER_PROFILE } from "../utility/constant";
import { checkEmail, checkPhoneNumber } from "../utility/utilities";
...
let showPopUpMoodal = ref(false);
let message = UPDATE_USER_PROFILE;
onMounted(() => getDataFromBackend(idOfUser));
const confirm = ()=> {
  showPopUpMoodal.value = false;
}
